...
def get_args():
    ...
    parser.add_argument('--rlf', dest='rlf_path', type=str,
                        default=None, required=True,
                        help='rlf project base directory')
...
if __name__ == '__main__':
    ...
    rlf_path = path.abspath(args.rlf_path)

    init_proj(args.source_path, proj_path, args.contract_name)
    deploy_contract(rlf_path, proj_path, args.contract_name)